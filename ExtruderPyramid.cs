...
public class ExtruderPyramid : MonoBehaviour {
	...
	void Start () {
		...
		//Vector3 [] resizeVals = new Vector3 [] {mov, new Vector3 (1.5f, 1.5f, 1.5f)};
		 ...
		 //Extruder.Extrude (mesh, currentFaces, false, Extruder.ExtrudePyramid, offsetVals);
		
		//Tiered square pyramid loops
		//for (int i = 0; i < 20; i +=1)
		//{
		//	Vector3 [] offsetVals = new Vector3 [] {mov, new Vector3 (i * 0.5f, 0, 0)};//Makes a tiered square
