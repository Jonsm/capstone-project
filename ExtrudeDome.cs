...
public class ExtrudeDome: MonoBehaviour {
	...
	void Start () {
		...
		Vector3 [] domeVals = new Vector3 [] {mov, new Vector3 (.2f, 0, 0)};
		//Extruder.Extrude (mesh, currentFaces, false, Extruder.ExtrudeWeirdClean, resizeVals);
		Extruder.Extrude (mesh, currentFaces, false, Extruder.ExtrudeDome, domeVals);
